...
findMoney(shoppers)
     ...
     */
      let books = [
        ...
        {title: "Is that a wisp", author: { firstName: "Suiyan", lastName: "Nayius"}},
        {title: "Huckleberry Finn", author: { firstName: "Mark", lastName: "Twain"}},
        {title: "Tom Sawyer", author: { firstName: "Samuel", lastName: "Clemens"}},
        {title: "Prince", author: { firstName: "Nicocolo", lastName: "Machiavelli"}}
    ]

function bookLoop(obj) {
          obj.forEach(x => {
